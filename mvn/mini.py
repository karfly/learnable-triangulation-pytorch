...
def get_config(config_path, data_folder='/home/stefano/Scuola/tud/_classes/4/thesis/data/'):
    ...
    config.cam2cam.model.backbone.n_layers = 2
    
    config.cam2cam.model.master.n_features = 16
    config.cam2cam.model.master.R.n_layers = 2
    config.cam2cam.model.master.t.n_layers = 2

    config.cam2cam.model.master2others.n_features = 16
    config.cam2cam.model.master2others.R.n_layers = 2
    config.cam2cam.model.master2others.t.n_layers = 2
