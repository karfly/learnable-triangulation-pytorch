...
def debug_live_training():
    ...
    pred = torch.tensor([
        [  -5374.0714,    6932.0832,   18238.6961],
        [  -4970.1804,    6496.4160,   19704.3116],
        [  -7520.1554,    9495.6249,   31454.2430],
        [ -16873.8005,   19484.2550,   63444.7674],
        [ -17524.6483,   20362.2439,   56687.0180],
        [  98151.4214, -106730.9712, -252994.6590],
        [ -10521.9341,   12704.0299,   41761.4136],
        [ -13845.8518,   16463.0665,   57604.4471],
        [ -17498.4028,   20270.5678,   78638.5302],
        [ -25685.8817,   29115.3745,  119924.7762],
        [  -7260.0195,    8906.9844,   32601.8678],
        [  -6785.0581,    8722.1636,   30643.3949],
        [  -9879.0697,   11987.4355,   46258.4820],
        [ -43679.4401,   48961.8124,  180541.5143],
        [ -75277.6828,   83131.8298,  277002.7357],
        [  -9669.7065,   11464.7546,   42083.2977],
        [ -13659.2680,   15798.0755,   65018.5375]
    ]).float()
