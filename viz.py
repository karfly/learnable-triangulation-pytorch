...
def debug_live_training():
    ...
    pred = torch.tensor([
        [11291.5609,  -628.8686,  -773.7211],
        [10225.6697,  1488.8259,  -886.5087],
        [ 8924.6259,  3609.3262,  -974.7342],
        [ 7943.7632,  3390.0957,   118.2953],
        [ 8577.2968,  1276.3847,   443.1146],
        [ 8892.4911,  -533.5375,   790.4133],
        [ 8410.3367,  3492.0816,  -422.9289],
        [ 8024.1401,  4827.8437,  -609.4286],
        [ 8049.3209,  6253.2474,  -903.0757],
        [ 8749.9455,  7401.8785, -1394.8521],
        [ 9321.3160,  5016.4079, -1282.8865],
        [ 9287.6961,  4689.2442, -1658.1477],
        [ 8481.5368,  6067.6658, -1435.2930],
        [ 7473.4211,  5869.5277,  -185.9174],
        [ 7407.7878,  4329.8128,   427.3607],
        [ 8609.2934,  4831.8789,  -520.6741],
        [ 8538.3166,  6675.8726, -1129.9222]
    ]).float()
    gt = torch.tensor([
