...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ 109.3705, -491.8031,  862.1009],
        [  39.6094, -148.1343,  502.7648],
        [-129.1607,   37.2362,   33.6869],
        [ 126.3843,  -37.7374,  -32.9370],
        [ 199.5086, -126.3960,  464.4885],
        [ 291.9654, -425.9500,  843.6290],
        [   0.0000,    0.0000,    0.0000],
        [ -68.0468,   31.6680, -255.3923],
        [-128.6994,   90.5054, -549.9085],
        [-196.8527,  145.4673, -719.7841],
        [-326.6916,  445.2228, -594.9877],
        [-286.6494,  443.2345, -299.0789],
        [-206.5473,  122.1235, -482.6346],
        [ -32.0960,   10.0380, -507.0624],
        [ 106.1121, -151.0719, -256.7425],
        [ 234.1041, -180.7087,   24.8557],
        [-201.9944,  172.1674, -587.4248]
    ]).float()
    gt = torch.tensor([
