...
def debug_live_training():
    ...
    pred = torch.tensor([
        [  -7.9326,  -83.1808, -289.1799],
        [ -14.7577,  -93.4647, -276.6058],
        [  19.4612, -107.2377, -309.5707],
        [  -5.3583,  -94.5034, -287.0371],
        [ -31.3898,  -84.6339, -261.0036],
        [ -25.0479,  -75.2425, -271.6607],
        [   7.2570, -100.8865, -298.2628],
        [   1.8770, -104.2045, -291.0022],
        [ -12.7554, -103.7953, -275.5878],
        [ -20.9717, -102.1651, -267.2902],
        [  44.9766, -121.0701, -332.9557],
        [  34.8883, -123.5708, -319.7042],
        [   3.1285, -112.5180, -288.9674],
        [ -26.6840,  -96.1731, -264.4732],
        [ -27.9408,  -94.0402, -266.7808],
        [ -23.1142,  -90.8996, -273.7284],
        [ -14.1367, -102.6661, -274.0676]
    ]).float()
