...
def debug_live_training():
    ...
    pred = torch.tensor([
        [  -176.4128, -10252.7035,    679.0688],
        [   236.3360, -13267.6994,    116.2428],
        [  -692.5440, -11923.3747,     56.8342],
        [  -702.7926, -11645.0454,    -20.3648],
        [   252.4313, -13267.4335,     43.0516],
        [  -161.1632, -10340.3361,    618.5270],
        [  -691.8729, -11726.5418,     18.5255],
        [  -599.8529, -12998.1348,   -327.9894],
        [  -194.3405, -15023.7961,   -795.0418],
        [   209.1601, -16149.3616,   -938.4288],
        [ -1133.6749, -12052.1780,    -60.5822],
        [  -933.7889, -13464.5618,   -471.6660],
        [  -289.7852, -15025.0991,   -772.6561],
        [  -198.7809, -15032.1116,   -846.1370],
        [  -796.4281, -14084.8569,   -854.0758],
        [ -1186.8385, -12362.3238,   -470.8330],
        [   -27.2218, -15090.6778,   -701.0323]
    ]).float()
