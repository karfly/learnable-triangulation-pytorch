...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ -30.3291, -238.3586,  -31.7910],
        [ -30.4490, -126.6590,  100.3629],
        [ -50.7787,    3.1505,    5.4448],
        [  50.7791,   -3.3423,   -4.6816],
        [  46.9384, -126.5081,  101.1846],
        [  50.2623, -240.3465,  -26.3221],
        [   0.0000,    0.0000,    0.0000],
        [  19.1735,   66.1738,   51.8930],
        [  40.0842,  110.2748,  135.8498],
        [  31.7189,   93.6632,  184.5744],
        [ -86.3601,  102.6664,  -18.5820],
        [ -57.6108,  161.4269,   48.0824],
        [  -8.8056,  128.7215,  131.8148],
        [  92.3459,  106.8980,  132.5763],
        [ 148.4730,  161.0196,   67.5561],
        [ 161.3318,  124.9279,  -17.1421],
        [  25.2160,   74.9308,  145.5184]
    ]).float()
