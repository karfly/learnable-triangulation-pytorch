...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-6.0927e-05, -4.4702e-04,  7.6301e-04],
        [-7.4680e-05, -3.0517e-04,  3.3954e-04],
        [ 1.0154e-04, -6.3771e-05, -8.1722e-06],
        [-1.0130e-04,  6.4391e-05,  8.8136e-06],
        [-1.5095e-04, -1.0916e-04,  4.2692e-04],
        [ 1.6364e-05, -4.3550e-05,  8.3826e-04],
        [ 0.0000e+00,  4.1255e-19, -6.2566e-19],
        [-6.2180e-05, -1.5495e-05, -2.1948e-04],
        [-1.4022e-04, -5.0166e-05, -4.6401e-04],
        [-1.1252e-04, -5.9845e-06, -6.1064e-04],
        [-2.7391e-04, -4.9417e-04, -2.8037e-04],
        [-5.1964e-05, -3.3619e-04, -2.6058e-04],
        [-3.7196e-05, -1.1422e-04, -4.2557e-04],
        [-2.4462e-04,  1.9651e-06, -4.3874e-04],
        [-4.6861e-04, -9.8394e-05, -3.0402e-04],
        [-4.0220e-04, -2.7942e-04, -3.9206e-04],
        [-1.6269e-04, -9.8279e-05, -5.5281e-04]
    ]).float()
