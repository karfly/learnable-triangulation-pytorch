...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-144.8861,   28.4304, -548.0576],
        [-128.6798,   15.4838, -272.5041],
        [ -71.5389,   63.0921,   10.7473],
        [  71.7596,  -63.4702,   -9.9695],
        [  93.3514,  -45.6504, -297.5870],
        [ 170.6150,   35.6980, -543.8762],
        [   0.0000,    0.0000,    0.0000],
        [   8.6769,    7.1009,  169.9732],
        [ -11.5088,  -23.1023,  328.2292],
        [ -85.6875,  -94.2779,  428.6606],
        [-125.3711,  -48.6521,  168.6786],
        [-140.8506,  103.7622,  136.8159],
        [ -73.8090,   63.3460,  305.1130],
        [  74.8249,  -86.4470,  292.6132],
        [ 124.6446, -127.6036,  113.4180],
        [ -30.8915, -120.7416,  152.8071],
        [ -58.8622,  -76.7272,  359.8828]
    ]).float()
