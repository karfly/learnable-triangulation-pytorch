...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ -77.9298, -195.7975,  -93.5701],
        [ -22.1293,  -56.8635,  -31.3199],
        [  16.0084,   33.1473,    9.8806],
        [ -18.3026,  -38.0093,  -11.2326],
        [ -51.4138, -117.1615,  -53.2172],
        [-111.9984, -269.1513, -122.6378],
        [   0.0000,    0.0000,    0.0000],
        [   4.6438,   18.3962,    4.2169],
        [   0.9541,   19.6559,    0.3794],
        [   9.8683,   40.7890,    7.5454],
        [  -1.7671,   24.6954,  -12.4370],
        [  16.3498,   51.6732,    2.3976],
        [  17.5902,   50.5676,   10.3762],
        [ -18.0237,  -19.2259,  -10.4844],
        [ -54.9621, -101.9509,  -41.8706],
        [ -43.3293,  -88.8161,  -40.6969],
        [   1.2118,   23.4585,   -1.9142]
    ]).float()
