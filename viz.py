...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-182.7363,  -99.4410, -109.8424],
        [-125.6305,  -59.0559,  -51.7135],
        [ -19.8587,    0.7280,   -8.4533],
        [  19.4938,   -1.0764,    8.1134],
        [-111.5198,  -62.0840,  -39.6646],
        [-197.5006, -103.0694, -107.3441],
        [   0.0000,    0.0000,    0.0000],
        [   5.8638,    9.7030,   41.1173],
        [  34.4504,   33.6263,   96.7392],
        [  82.6913,   64.3581,  144.1779],
        [ -98.3560,  -43.7675,  -31.0904],
        [ -53.8288,  -13.6217,   12.9388],
        [   2.8983,   24.8239,   71.8067],
        [  42.4965,   27.1557,   97.2996],
        [ -25.2494,  -13.8482,   31.0493],
        [ -79.8289,  -44.7581,  -20.1108],
        [  53.9699,   44.1955,  126.0708]
    ]).float()
