...
def debug_live_training():
    ...
    pred = torch.tensor([
        [  22.0910,  -52.1813, -525.7118],
        [  24.7135,  -46.7147, -491.9727],
        [  24.3231,  -51.1427, -468.8523],
        [  30.0271,  -43.8271, -459.3624],
        [  28.5741,  -44.6555, -486.8115],
        [  27.4265,  -47.1085, -519.1550],
        [  27.2580,  -47.3842, -463.9049],
        [  26.3797,  -50.0658, -453.9475],
        [  27.4537,  -50.0742, -440.1795],
        [  27.2961,  -51.7803, -431.6380],
        [  21.6549,  -52.8668, -474.9800],
        [  22.5075,  -54.4212, -462.6555],
        [  24.6167,  -53.5835, -446.9086],
        [  29.8282,  -46.1438, -441.4461],
        [  31.5514,  -42.0718, -451.1448],
        [  32.3958,  -38.4163, -458.4777],
        [  27.7149,  -50.2636, -434.6992]
    ]).float()
