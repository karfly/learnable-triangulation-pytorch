...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-154.9382, -657.0276, -601.3262],
        [  32.3269, -650.7912, -351.0151],
        [ 227.8231, -491.1730, -128.6937],
        [ 399.0828, -374.8475, -196.0506],
        [ 152.2452, -631.3545, -400.0301],
        [-166.2577, -686.3713, -599.3365],
        [ 316.1211, -431.9251, -163.0981],
        [ 422.7189, -429.1580,  -54.3381],
        [ 541.4784, -404.8698,   86.7869],
        [ 629.8450, -360.1781,  182.5429],
        [ 120.3706, -628.9789, -274.4521],
        [ 276.2787, -583.4912,  -95.6981],
        [ 443.1266, -496.7654,  103.7404],
        [ 585.7978, -356.4978,   17.4870],
        [ 436.4864, -470.0603, -149.1923],
        [ 239.6168, -583.3436, -315.5073],
        [ 615.5896, -378.6543,  122.0065]
    ]).float()
