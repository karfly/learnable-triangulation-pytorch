...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-191.2432,   17.5014, -543.5554],
        [-285.1138,   57.3332, -427.8184],
        [  -9.9884,   -4.3298,  -53.9256],
        [  19.1083,    1.9676,   62.9635],
        [-145.1046,   36.9627, -268.7254],
        [-170.2893,   26.3478, -478.2597],
        [   0.0000,    0.0000,    0.0000],
        [ 155.0954,  -47.8769,  207.9532],
        [ 301.5052,  -93.9316,  451.1343],
        [ 417.8847, -136.5623,  626.7678],
        [-130.8234,   22.3316, -205.6536],
        [  67.8739,  -31.5507,   54.9444],
        [ 247.3692,  -84.5277,  341.3024],
        [ 257.1746,  -70.2263,  409.1858],
        [  69.9667,   -8.7155,  175.7707],
        [-162.0093,   49.2425,  -71.8532],
        [ 317.0727, -100.0109,  505.1062]
    ]).float()
