...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ -28.5352,  -12.9717, -735.3161],
        [ -51.6142,   -7.1757, -363.3920],
        [-111.0807,    8.4655,   -5.8780],
        [ 119.4167,   -7.3277,    2.6422],
        [ 125.3985,  -25.6678, -363.8135],
        [ 128.4684,  -26.6814, -749.6100],
        [   0.0000,    0.0000,    0.0000],
        [  11.2486,  -29.6602,  108.0670],
        [  61.4575,  -69.6131,  177.9148],
        [  25.4129,  -74.5676,  261.7810],
        [  35.3765, -124.2244,   31.3839],
        [-122.7597,  -70.3291,  -22.2554],
        [ -69.5763,  -47.3352,  135.1950],
        [ 188.4278,  -76.8692,  182.7301],
        [ 336.9719,  -76.9391,  -22.0871],
        [ 181.0478,  -46.8044, -196.6384],
        [  57.4055,  -85.9232,  166.5416]
    ]).float()
