...
def debug_live_training():
    ...
    gt = torch.tensor([
        [ -60.2966,  842.2069,  251.2313],
        [-111.6372,  432.3915,  103.5336],
        [-141.5722,  -13.5750,   35.3041],
        [ 141.5710,   13.5749,  -35.3038],
        [ 120.9369,  460.1714, -102.8467],
        [ 221.8742,  691.6166,  255.8230],
        [   0.0000,    0.0000,    0.0000],
        [   3.0987, -260.5302,  -18.6483],
        [ -52.9138, -494.2334,  -91.1646],
        [ -79.7582, -684.8411, -198.9372],
        [-287.3964,   72.7512,  115.8847],
        [-234.8241, -165.5880,  123.1793],
        [-175.9953, -420.8885,   -0.9463],
        [ 109.4406, -458.8600, -123.6882],
        [ 288.0076, -230.4878, -126.3268],
        [  71.6295, -303.9513, -212.3852],
        [ -72.0263, -571.4098, -181.6565]
    ]).float()
