...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ 144.1698, -106.9345,  106.9352],
        [  57.3923,  -42.0646,   47.9392],
        [ -32.6253,    5.4151,  -24.0279],
        [  30.7441,   -5.2330,   22.1884],
        [ 101.3053,  -51.1009,   79.7984],
        [ 204.2944, -122.7941,  137.3979],
        [   0.0000,    0.0000,    0.0000],
        [  72.3084,   -2.6386,   39.4384],
        [ 111.0424,    6.5945,   57.8573],
        [ 123.8660,   17.8547,   58.8008],
        [  55.0118,  -29.7726,   42.0846],
        [  68.1814,  -11.4497,   39.4079],
        [  90.0503,    6.5649,   40.9741],
        [ 122.0846,    1.1742,   71.3058],
        [ 102.4964,  -17.4071,   68.5499],
        [  85.0213,  -35.2748,   65.4064],
        [ 126.9780,   10.2783,   68.5832]
    ]).float()
