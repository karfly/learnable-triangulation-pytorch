...
def debug_live_training():
    ...
    pred = torch.tensor([
        [-367.0722, -484.2992,  592.2671],
        [-148.6774, -245.7382,  354.3112],
        [ 105.9387,  -94.4036,   45.7349],
        [-107.5880,   94.5898,  -46.1593],
        [-340.9710,   39.1136,  320.6381],
        [-585.2473, -234.0266,  561.6866],
        [   0.0000,    0.0000,    0.0000],
        [ 126.3176,  103.5161, -160.3272],
        [ 269.1624,  255.2396, -308.9948],
        [ 360.3049,  386.2489, -347.5792],
        [ 297.1278,   50.8086,   10.7566],
        [ 282.4770, -119.4659,  -79.9621],
        [ 348.7553,  108.5813, -246.6621],
        [ 130.8915,  287.1508, -343.3540],
        [ -85.1284,  206.3559, -230.7501],
        [ -10.2561,  348.9206, -186.7816],
        [ 288.1258,  354.8605, -257.2990]
    ]).float()
    gt = torch.tensor([
        [ -53.8812,   41.5942, -850.4962],
        [ -96.7594,  -90.0427, -434.9409],
        [-134.7932,   17.1154,   -0.9759],
        [ 134.7930,  -17.1154,    0.9759],
        [ 132.3167, -207.7351, -405.1186],
        [ 188.1458, -137.8220, -833.8922],
        [   0.0000,    0.0000,    0.0000],
        [ -10.0504,  -25.1458,  224.6244],
        [ -25.5815, -119.1492,  461.5952],
        [ -48.5325, -231.2244,  581.8032],
        [-209.7625, -161.6219,  178.8657],
        [-217.4306,   85.2057,  192.0447],
        [-142.9356,  -60.1247,  414.0118],
        [ 106.7881,  -92.1894,  425.9233],
        [ 226.1659,   -5.4374,  193.2039],
        [ 165.0444, -234.1157,  264.8069],
        [ -41.3020, -224.9891,  467.1971]
    ]).float()
