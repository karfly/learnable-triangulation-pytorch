...
def debug_live_training():
    ...
    pred = torch.tensor([
        [ 471.7974, -533.3554,  450.5860],
        [ 180.0831, -351.2219,  200.5959],
        [-122.5964,  -57.0311,   56.9915],
        [ 126.4225,   56.7109,  -55.8581],
        [ 219.5803, -414.1133,  -24.9612],
        [ 280.5677, -836.6557,  100.4562],
        [   0.0000,    0.0000,    0.0000],
        [-110.3963,  211.0587,  -15.5832],
        [-270.8083,  431.4041,  -57.0222],
        [-377.0012,  562.1659,  -87.9660],
        [-206.5057,   72.8330, -170.6895],
        [-301.2033,   15.7879,   53.8978],
        [-351.8680,  305.5105,   -5.8103],
        [-121.5213,  491.4344,  -72.1916],
        [ 176.5899,  505.3009,  -76.7303],
        [  50.5461,  633.2654, -250.7551],
        [-311.4523,  475.7819, -147.3436]
    ]).float()
    gt = torch.tensor([
