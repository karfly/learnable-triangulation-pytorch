...
def debug_live_training():
    ...
    pred = torch.tensor([
        [  -2.8077, -638.5763,  362.4593],
        [  -9.4240, -648.1184,  328.7164],
        [  -7.5320, -573.5433,  262.5507],
        [   8.1286, -593.4378,  271.5219],
        [  12.1171, -720.9550,  354.5890],
        [  11.1768, -681.4228,  376.4991],
        [   0.0000,    0.0000,    0.0000],
        [   2.1008, -541.2657,  237.8797],
        [   3.3680, -521.5989,  219.3273],
        [   1.8062, -522.0875,  212.1833],
        [  -7.7694, -577.3481,  230.4567],
        [ -15.1581, -553.3919,  232.2383],
        [  -2.1720, -512.5293,  218.1456],
        [   9.2140, -541.0961,  228.0871],
        [  17.4070, -625.5329,  253.8938],
        [   5.6823, -600.7982,  235.2343],
        [   2.4781, -541.9698,  221.9667]
    ]).float()
